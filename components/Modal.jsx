...
const Modal = ({ isSearching }) => {
  ...
  return (
    <div className='fixed  top-4 left-4 right-4 bottom-4 bg-gray-200/90 z-50 flex items-center justify-center flex-wrap overflow-auto p-4 gap-8 shadow-lg rounded-md'>
      <span
